...
common_voice_val_dataloader = AudioDataloaderWrapper(DataLoader(
    ...
    num_workers=val_num_workers, pin_memory=True, collate_fn=collate_fn
))
...
model_dir = 'models/8_recovered_v3'
...
load_from_ckpt(model, '/home/mnakhodnov/sirius-stt/models/8_recovered_v2/epoch_1.pt')
